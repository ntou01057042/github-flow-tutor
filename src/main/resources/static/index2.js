...
window.addEventListener('load', () => {
    ...
    branchLocalAButton = document.getElementById('branch-local-a-button');
    commitLocalAButton = document.getElementById('commit-local-a-button');
    ...
    pushLocalAButton = document.getElementById('push-local-a-button');
    ...
    branchLocalBButton = document.getElementById('branch-local-b-button');
    commitLocalBButton = document.getElementById('commit-local-b-button');
    ...
    pushLocalBButton = document.getElementById('push-local-b-button');
    ...
    branchLocalAButton.addEventListener('click', async () => {
    ...
    commitLocalAButton.addEventListener('click', async () => {
    ...
    mergeLocalAButton.addEventListener('click', async () => {
        ...
        console.log('testtttttttttttt:', currentBranch.localA.dataset.branch);
        console.log('testttttttttttttttt:', timestamp);
        // render diagram
        diagramSyntax.localA += `\ncheckout ${currentBranch.localA.dataset.branch}`;
        diagramSyntax.localA += `\nmerge ${mergeLocalAInput.value}`;
        diagram.localA.innerHTML = diagramSyntax.localA;
    ...
    pushLocalAButton.addEventListener('click', () => {
        // push commands
        $.ajax({
            contentType: 'application/json',
            ...
            success: function () {
                ...
                // push branches
                console.log('aaaaaaaaaaaaa:', [...branches.localA.values()]);
                $.ajax({
                    contentType: 'application/json',
    ...
    commitLocalBButton.addEventListener('click', async () => {
    ...
    branchLocalBButton.addEventListener('click', async () => {
    ...
    pushLocalBButton.addEventListener('click', () => {
        $.ajax({
            contentType: 'application/json',
